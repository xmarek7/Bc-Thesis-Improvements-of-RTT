...
In Chapter \ref{chap:rand}, we explained the principles of randomness testing along with all terms used in the following chapters. This chapter may also be used by users new to randomness testing. The aforementioned programs for randomness testing are presented in Chapter \ref{chap:sols}.
